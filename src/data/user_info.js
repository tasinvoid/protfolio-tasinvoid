const info = {
  // ============ MAIN DETAILS ============
  main: {
    name: "Shoaib Mahmud Tasin",
    description:
      "I am a software engineer with expertise in full-stack web development. I have experience in building scalable, secure and reliable web applications using MERN stack. I enjoy solving complex problems and learning new skills. I am passionate about creating high-quality code that follows best practices and industry standards.",
    role: "Full-Stack Developer",
    photo:
      "https://i.ibb.co.com/xngp0Y4/8a-NISOx-PAhb-Zoufm-BUt-Ml-ZCoc-KJ.jpg",
    email: "shoaibmahmudtasin@gmail.com",
  },

  // ============ SOCIAL LINKS ============
  socials: {
    github: "https://github.com/tasinvoid",
    linkedin: "www.linkedin.com/in/shoaib-mahmud-tasin",
    facebook: "https://www.facebook.com/profile.php?id=61573135861799",
  },

  // ============ PROJECTS ============
  projects: [
    {
      title: "Buildia: Smart Building Management",
      description:
        "A comprehensive web application for managing a single building, with role-based dashboards for users, members, and admins. It streamlines apartment rentals, payment processing, and community announcements.",
      technologies:
    ...
    },
    {
      ...
      description:
        "A full-stack web application designed to combat food waste by connecting users with surplus food. It features comprehensive CRUD operations, a food request system, and secure authentication.",
      technologies:
