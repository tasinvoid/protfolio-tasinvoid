    ...
    <div className="hover:bg-zinc-100 hover:dark:bg-zinc-900 transition-all duration-300 p-6 md:rounded-xl">
      <div className="flex flex-wrap gap-2 py-2">
        ...
        {technologies.split(",").map((tech, index) => (
          <div
            className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-red-800/30 dark:text-red-500 h-8"
            key={index}
          >
            {tech}
          </div>
      ...
      <div className="mt-4">
        <span>
          {" "}
          <p className="text-red-400">Challenges:</p>
